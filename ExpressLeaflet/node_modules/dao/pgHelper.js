...
var conString = "postgres://postgres:123456@172.16.206.91:5432/NE_Vehicle";
...
PG.prototype.getConnection = function(){
    client.connect(function (err) {
        ...
        client.query('SELECT NOW() AS "theTime"', function (err, result) {
            ...
            console.log("NE_Vehicle 数据库连接成功...");
        });
    });
};
...
PG.prototype.selectFacPop_BypolygonId =function(tablename,fields,returnfields,cb){
    if(!tablename) return;
    var returnStr = "";
    //如果返回字段为空
    if(returnfields.length == 0)
    ...
    if(fields.length == 0)
        ...
        // 否则根据条件字段进行查询
        str = "select "+returnStr+ " from "+tablename+" where polygon_id = '"+ fields+"' order by date";
    console.log("strsql...:"+str);
    //console.log("value...:"+value);
    clientHelper(str,'',cb);
}
